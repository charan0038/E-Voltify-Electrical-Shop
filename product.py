                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a href="#inlog" class="nav-link" data-bs-toggle="modal" data-bs-target="#sing">
                            <i class="bi bi-door-open"></i> Sing up
                        </a>
                    </li>
                </ul>
            </div>
...
if submit:
    ...
    if r is not None:
        print("""
                ...
                location.href='productlog.py?id=%s';
                </script>
            """ % (r[0]))
    else:
        print("""
                ...
                <div class="modal-body">
                    <form action="" class="form-group" name="login-form">
                        ...
                        <input type="password" id="password" class="form-control" required
                            placeholder="Enter Your New Password..!" name="Password"><br>
            ...
            <div class="row"><br><br><br>
                ...
                <div class="col-md-4" align="center">
                    ...
                    <div class="link">
                        ...
                        </a><a href=""><span class="fa fa-twitter"></span></a>
                    </div>
                    </p>
                </div>
                <div class="col-md-4" align="center">
