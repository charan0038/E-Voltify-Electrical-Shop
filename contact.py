                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="./havells.py">Havells</a></li>
...
if submit:
    ...
    if r is not None:
        print("""
                ...
                location.href='contactlog.py?id=%s';
                </script>
            """ % (r[0]))
    else:
        print("""
...
print("""
                        ...
                        <div class=" container " id="con">
                            ...
                            <form action="" method="post" class="form-group col-4 " >
                                <fieldset><br><br>
...
if submit:
    p = """INSERT INTO contact (name, email, mobile, massage) VALUES ('%s', '%s', '%s', '%s')""" % (
