                ...
                <ul class="navbar-nav">
                    ...
                    <div class="dropdown profile-dropdown ">
                        ...
                        <ul class="dropdown-menu left">
                            ...
                            <li><a class="dropdown-item" href="edit.py?id={uid}">Account Settings</a></li>
                            <li><a class="dropdown-item text-danger" href="./contact.py" id="logoutBtn">Logout</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<style>
#con{
    background-image: url(./media/rrrr.jpg);
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="" class="form-group">
                        ...
                        <input type="number" name="Mobile number" id="Mobile number" class="form-control" required
                            placeholder="Please Enter your mobile number"><br>
                        <label for="">Email:</label>
                        <input type="email" name="mail" id="mail" class="form-control" required
                            placeholder="Please Enter Your Email-id"><br>
                        <label for="Address "> Address:</label>
                        <textarea name="text-area  " class="form-control width" rows="4" cols="200" id=""
                            required></textarea><br><br>
                        <label for="">password:</label>
                        <input type="password"  required
                            placeholder="Please Enter Your Password" class="form-control"><br>
                        <input type="submit"  data-bs-target="#log" data-bs-toggle="modal" class="btn btn-primary form-control">
                    ...
                    <input type="reset" name="cancel" value="cancel" class="btn btn-danger">
                        ...
                        <div class=" container " id="con">
                            ...
                            <form method="post" class="form-group col-4 " >
                                <fieldset><br><br>
                                <legend  align="center">CONTACT FORM</legend><br><br>
                                <label for=""> Name </label>
                                    <input type="text" name="name" id="name" class="form-control width" required placeholder="Please Enter Your Name"><br>
                                <label for=""> E-mail </label>
                                    <input type="email" name="mail" id="mail" class="form-control width" required placeholder="Please Enter Your Email-id"><br>
                                <label for="number"> Mobile-Number </label>
                                    <input type="number" name="Number" required  placeholder="Please Enter Your Mobile Number" class="form-control width"><br>
                                <label for=""> Massage </label>
                                    <textarea type="text-area" name="massage" class="form-control width" rows="4" cols="10"></textarea><br><br>
...
massage = form.getvalue("massage")
csubmit = form.getvalue("csubmit")

if csubmit:
    p = """INSERT INTO contact (name, email, mobile, masage) VALUES ('%s', '%s', '%s', '%s')""" % (
        name, email, number, massage)
    cur.execute(p)
    con.commit()

    fromadd = "charankalidass1234@gmail.com"
    password = "phgm cfnr izrb lcnv"
    toadd = email
    subject = "SRI PALANI MURUGAN AGENCIES"
    body = "THANKS FOR CONTACTING US, {}".format(name)
...
print("""
            <div class="col-lg-6" align="center">                       
                            ...
                            <fieldset><br><br>
                                <legend > INFORMATION </legend><br><br><br>
                                <a href="" id="k" ><i class="bi bi-geo-alt-fill"></i> 1/189-1,Vadakku Thottam Salai,<br>Malumichampatti,<br>Coimbatore-641050</a><br><br>
                                <a href="" id="k"><i class="bi bi-envelope-fill"></i> spmagencies1819@gmail.com</a><br><br>
                                <a href="" id="k"><i class="bi bi-telephone-fill"></i> +91 7708166635</a>
                                </fieldset>
